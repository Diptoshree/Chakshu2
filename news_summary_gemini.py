...
def extract_text_from_image(image):
    ...
    The headline may be spread across multiple lines but should have the same font and size.
...
def generate_summary(article_text):
    ...
    The summary should have less than {max(len(article_text.split()) // 2, 150)} words.
    The language of the 
